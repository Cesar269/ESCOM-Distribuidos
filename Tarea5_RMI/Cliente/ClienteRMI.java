...
public class ClienteRMI {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String url3 = "rmi://localhost/prueba";
        ...
        double[][] C9  = r2.multiplica_matrices(A3, B1,N);
        double[][] C10 = r2.multiplica_matrices(A3, B2,N);
        double[][] C11 = r2.multiplica_matrices(A3, B3,N);
        double[][] C12 = r2.multiplica_matrices(A3, B4,N);

        double[][] C13 = r3.multiplica_matrices(A4, B1,N);
        double[][] C14 = r3.multiplica_matrices(A4, B2,N);
        double[][] C15 = r3.multiplica_matrices(A4, B3,N);
        double[][] C16 = r3.multiplica_matrices(A4, B4,N);
